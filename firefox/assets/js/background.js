...
const initialState={disabled:!1,focus_mode:!0,modern_mode:!0,dark_mode:!0,disable_aboutme:!1,board_100vh:!1,coor_bigger:!1,coor_each:!1,bigger_controls:!1,disable_chat:!1,disable_chat_unless:!1,reload_disconnect:!0,single_resign:!1,add_fullscreen:!0,reload_disconnect_1:!0,reload_disconnect_2:!1,theme:"modern",font:"inter",pieces:"pjaworski_muesli",board:"nightindesert"},browser_cr=chrome||browser;function initStateIfNotExist(){browser_cr.storage.local.get("formState",e=>{chrome.storage.local.set({formState:{...initialState}}),e.formState&&0!==Object.keys(e.formState).length||browser_cr.storage.local.set({formState:{...initialState}})})}initStateIfNotExist(),browser_cr.runtime.onInstalled.addListener(function(){browser_cr.tabs.create({url:"https://chesscolibri.pro/welcome-li"})}),browser_cr.runtime.setUninstallURL("https://docs.google.com/forms/d/e/1FAIpQLSfH54zUfiG54rUMWu5ynVjQRP0h6tGfseoL56sYoBfke9AGtw/viewform?usp=sf_link");